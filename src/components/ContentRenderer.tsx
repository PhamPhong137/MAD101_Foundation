            ...
            case 'formula':
                return (
                    <div key={index} className="formula-box mb-4">
                        <div className="text-primary-300 text-center whitespace-pre-wrap">
                            {block.content as string}
                        </div>
                    </div>
                );
                ...
                return (
                    <div key={index} className="theorem-box mb-4">
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                {block.title && (
                                    <h4 className="text-primary-300 font-semibold mb-2">{block.title}</h4>
                                )}
                                <p className="text-gray-300 whitespace-pre-wrap">{block.content as string}</p>
                            </div>
                        </div>
                    </div>
                );
                ...
                return (
                    <div key={index} className="note-box mb-4">
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                {block.title && (
                                    <h4 className="text-secondary-300 font-semibold mb-2">{block.title}</h4>
                                )}
                                <p className="text-gray-300 whitespace-pre-wrap">{block.content as string}</p>
                            </div>
                        </div>
                ...
                return (
                    <div key={index} className="example-box mb-4">
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                {block.title && (
                                    <h4 className="text-green-300 font-semibold mb-2">{block.title}</h4>
                                )}
                                <p className="text-gray-300 whitespace-pre-wrap">{block.content as string}</p>
                            </div>
                        </div>
