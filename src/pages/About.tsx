            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6">
                        ...
                        <span className="text-blue-400 font-medium">Giới thiệu</span>
                    </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="glass-card p-8">
                        ...
                        <p className="text-gray-300 leading-relaxed mb-4">
                            <strong className="text-white">MAD101 Study Guide</strong> là một nền tảng học tập trực tuyến
                            được thiết kế để giúp sinh viên FPT University ôn tập và nắm vững kiến thức môn
                            <strong className="text-primary-400"> Discrete Mathematics (MAD101)</strong>.
                        </p>
                    ...
                    <div className="glass-card p-8">
                        <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
                            <Target className="w-6 h-6 mr-3 text-secondary-400" />
                            Tính năng chính
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 bg-white/5 rounded-xl">
                                <h3 className="text-white font-semibold mb-2">📚 Tổng hợp kiến thức</h3>
                                <p className="text-gray-400 text-sm">8 chương học với đầy đủ lý thuyết, định lý và ví dụ minh họa</p>
                            </div>
                            <div className="p-4 bg-white/5 rounded-xl">
                                <h3 className="text-white font-semibold mb-2">📝 Công thức quan trọng</h3>
                                <p className="text-gray-400 text-sm">Tất cả công thức cần nhớ, được phân loại theo chủ đề</p>
                            </div>
                            <div className="p-4 bg-white/5 rounded-xl">
                                <h3 className="text-white font-semibold mb-2">🧠 Luyện tập trắc nghiệm</h3>
                                <p className="text-gray-400 text-sm">Quiz với giải thích chi tiết giúp ôn tập hiệu quả</p>
                            </div>
                            <div className="p-4 bg-white/5 rounded-xl">
                                <h3 className="text-white font-semibold mb-2">🎨 Giao diện hiện đại</h3>
                                <p className="text-gray-400 text-sm">Thiết kế đẹp mắt, dễ sử dụng trên mọi thiết bị</p>
                            </div>
                        </div>
                    </div>
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-4">
                                            <span className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-500/20 to-secondary-500/20 flex items-center justify-center text-primary-400 font-mono">
                                                {chapter.num}
                                            </span>
                                            <div>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <h3 className="text-white font-medium group-hover:text-primary-400">Liên hệ thắc mắc kiến thức</h3>
                                    <p className="text-gray-400 text-sm">Facebook - Hỗ trợ giải đáp thắc mắc</p>
                                </div>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <h3 className="text-white font-medium group-hover:text-primary-400">PT 1: Các câu khó</h3>
                                    <p className="text-gray-400 text-sm">Google Docs - Bộ đề khó phần 1</p>
                                </div>
                                <ExternalLink className="w-4 h-4 text-gray-500" />
                            </a>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <h3 className="text-white font-medium group-hover:text-primary-400">PT 2: Các câu khó</h3>
                                    <p className="text-gray-400 text-sm">Google Docs - Bộ đề khó phần 2</p>
                                </div>
                                <ExternalLink className="w-4 h-4 text-gray-500" />
                            </a>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <h3 className="text-white font-medium group-hover:text-primary-400">PT 3: Các câu khó</h3>
                                    <p className="text-gray-400 text-sm">Google Docs - Bộ đề khó phần 3</p>
                                </div>
                                <ExternalLink className="w-4 h-4 text-gray-500" />
                            </a>
                        </div>
