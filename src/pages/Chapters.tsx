            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-primary-500/10 border border-primary-500/20 mb-6">
                        ...
                        <span className="text-primary-400 font-medium">Tất cả các chương</span>
                    </div>
                ...
                <div className="mt-16 glass-card p-8">
                    <h3 className="text-xl font-bold text-white mb-6 text-center">Tổng quan nội dung</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="text-center p-4 bg-white/5 rounded-xl">
                            <div className="text-3xl font-bold text-primary-400 mb-1">{chapters.length}</div>
                        ...
                        <div className="text-center p-4 bg-white/5 rounded-xl">
                            ...
                            <div className="text-sm text-gray-400">Chủ đề</div>
                        </div>
                        <div className="text-center p-4 bg-white/5 rounded-xl">
                            <div className="text-3xl font-bold text-green-400 mb-1">100+</div>
                            <div className="text-sm text-gray-400">Công thức</div>
                        </div>
                        <div className="text-center p-4 bg-white/5 rounded-xl">
                            <div className="text-3xl font-bold text-orange-400 mb-1">50+</div>
                            <div className="text-sm text-gray-400">Ví dụ</div>
                        </div>
                    </div>
                </div>
            </div>
