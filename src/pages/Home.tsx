        ...
        <div className="min-h-screen">
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-primary-500/10 to-secondary-500/10 rounded-full blur-3xl animate-float" />
                </div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    {/* Badge */}
                    <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 mb-8 animate-slide-down">
                        <Sparkles className="w-4 h-4 text-yellow-400" />
                        <span className="text-sm text-gray-300">FPT University - Discrete Mathematics</span>
                    </div>
                    ...
                    {/* Subheading */}
                    <p className="text-xl sm:text-2xl text-gray-400 max-w-3xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: '100ms' }}>
                        Tổng hợp kiến thức <span className="text-primary-400">Toán Rời Rạc</span> một cách
                        <span className="text-secondary-400"> trực quan</span> và
                        <span className="text-green-400"> dễ hiểu</span>
                    </p>
                    ...
                    <div className="grid grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto mt-16 animate-fade-in" style={{ animationDelay: '400ms' }}>
                        <div className="glass-card p-4 sm:p-6">
                            ...
                            <div className="text-xs sm:text-sm text-gray-400">Chương học</div>
                        </div>
                        <div className="glass-card p-4 sm:p-6">
                            <div className="text-3xl sm:text-4xl font-bold gradient-text mb-1">
                                {chapters.reduce((acc, ch) => acc + ch.topics.length, 0)}
                            </div>
                            <div className="text-xs sm:text-sm text-gray-400">Chủ đề</div>
                        </div>
                        <div className="glass-card p-4 sm:p-6">
                            <div className="text-3xl sm:text-4xl font-bold gradient-text mb-1">∞</div>
                            <div className="text-xs sm:text-sm text-gray-400">Kiến thức</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="glass-card-hover p-8 text-center">
                            ...
                            <h3 className="text-xl font-bold text-white mb-3">Trực quan & Dễ hiểu</h3>
                        ...
                        <div className="glass-card-hover p-8 text-center">
                            ...
                            <h3 className="text-xl font-bold text-white mb-3">Tập trung vào FE</h3>
                            <p className="text-gray-400">
                        ...
                        <div className="glass-card-hover p-8 text-center">
                            ...
                            <h3 className="text-xl font-bold text-white mb-3">Cộng đồng hỗ trợ</h3>
                            <p className="text-gray-400">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-primary-500/5 to-transparent">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col sm:flex-row items-center justify-between mb-12 gap-4">
                        <div>
                            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-2">Các chương nổi bật</h2>
                            <p className="text-gray-400">Bắt đầu với những kiến thức cơ bản nhất</p>
                        </div>
                        <Link
                            to="/chapters"
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    <div className="glass-card p-8 md:p-12 text-center relative overflow-hidden">
                        ...
                        <div className="absolute top-0 left-0 w-40 h-40 bg-primary-500/20 rounded-full blur-3xl" />
                        <div className="absolute bottom-0 right-0 w-40 h-40 bg-secondary-500/20 rounded-full blur-3xl" />
