        ...
        <div className="min-h-screen">
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary-300/20 dark:bg-primary-400/10 rounded-full blur-3xl animate-pulse-slow animation-delay-2000" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary-500/5 dark:bg-primary-500/10 rounded-full blur-3xl animate-float" />
                </div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: '100ms' }}>
                        Tổng hợp kiến thức <span className="text-primary-600 dark:text-primary-400 font-medium">Toán Rời Rạc</span> một cách trực quan và dễ hiểu
                    </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
                        ...
                        <div className="lg:col-span-4">
                            <h2 className="text-3xl sm:text-4xl font-bold font-display text-gray-900 dark:text-white tracking-tight mb-4">
                                Tại sao chọn <span className="gradient-text">MAD101</span>?
                            </h2>
                            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                                Nền tảng học tập được thiết kế đặc biệt cho sinh viên FPT, tập trung vào những gì thực sự xuất hiện trong đề thi.
                            </p>
                        </div>

                        {/* Feature rows */}
                        <div className="lg:col-span-8 divide-y divide-gray-200 dark:divide-white/10">
                            <div className="flex items-start gap-6 py-6 first:pt-0">
                                <div className="w-12 h-12 shrink-0 rounded-xl bg-primary-500/10 flex items-center justify-center">
                                    <Zap className="w-6 h-6 text-primary-600 dark:text-primary-400" />
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Trực quan & Dễ hiểu</h3>
                            ...
                            <div className="flex items-start gap-6 py-6">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Tập trung vào FE</h3>
                                    <p className="text-gray-600 dark:text-gray-400">
                            ...
                            <div className="flex items-start gap-6 py-6 last:pb-0">
                                <div className="w-12 h-12 shrink-0 rounded-xl bg-primary-500/10 flex items-center justify-center">
                                    <Users className="w-6 h-6 text-primary-600 dark:text-primary-400" />
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Cộng đồng hỗ trợ</h3>
                                    <p className="text-gray-600 dark:text-gray-400">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    <div className="glass-card p-8 md:p-12 text-center relative overflow-hidden">
                        ...
                        <div className="absolute bottom-0 right-0 w-40 h-40 bg-primary-300/20 dark:bg-primary-400/10 rounded-full blur-3xl" />
